...
const Subscribe = () => {
  return (
    <div className="subscribe">
      ...
      <button className="px-6 py-3.5 font-semibold bg-turquoise text-eerieBlack rounded mt-6 md:mt-12  h-12 md:px-[55px] md:w-[240px] text-center font-inter text-[14px] leading-[24px]">        SUBSCRIBE NOW
      </button>
    </div>
  )
}
