...
const PaymentAction = ({ action, disabled }) => {
  return (
    <>
      <DesktopMDContainer>
        <LargePrimaryButton
          className="md:block hidden cta-button bg-turquoise"
          title="REVIEW ORDER"
          disabled={disabled}
          onClick={action}
        />
...
const ReviewOrderAction = ({ action }) => {
  return (
    <>
      ...
      <MobileMDContainer>
        <LargePrimaryButton className='cta-button bg-turquoise' title="CONFIRM AND PAY" onClick={action} />
      </MobileMDContainer>
    </>
  )
}
        ...
        <div className="approvalDialog">
          ...
          <div className="approvalDialogContent">
            ...
            <div className="approvalDialogFooter">
              ...
              />
              <LargePrimaryButton
                className="md:block hidden bg-turquoise mt-[50px]"
                title="SUBMIT"
              ...
              (
                <div className='deferredPaymentBox'>
                  ...
                  {!payment.requiresInitialization && (<FilledButton
                    ...
                    className="mt-4 w-auto bg-turquoise text-eerieBlack"
                  >
                    PAY
                  </FilledButton>)}
                </div>
